    ...
    $.ajax({
        ...
        success: function(data){
            if(data.helper){
                ...
                $('#sel_item_edit_type').val(data.helper.item.type);
...
//9_copy
$("#tbl_list").on("click", ".link_item_copy", function(){ if (confirm("Are you sure?")) {
