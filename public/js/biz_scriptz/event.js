    ...
    $.ajax({
        ...
        success: function(data){
            if(data.helper){
                ...
                $('#tb_item_edit_price').val(data.helper.item.price);
                $('#tb_item_edit_old_price').val(data.helper.item.old_price);
                $('#tb_item_edit_meeting_link').val(data.helper.item.meeting_link);
                $('#tb_item_edit_website').val(data.helper.item.website);
                $('#tb_item_edit_type').val(data.helper.item.type);
                $('#tb_item_edit_start_date').val(data.helper.item.start_date);
                $('#tb_item_edit_start_time').val(data.helper.item.start_time);
...
//9_item_submit//9_item_update//9_update
$('#btn_item_submit').click(function(){
    ...
    obj.price=$('#tb_item_edit_price').val();
    obj.old_price=$('#tb_item_edit_old_price').val();
    obj.website=$('#tb_item_edit_website').val();
    obj.meeting_link=$('#tb_item_edit_meeting_link').val();
    obj.type=$('#tb_item_edit_type').val();
    obj.start_date=$('#tb_item_edit_start_date').val();
    obj.start_time=$('#tb_item_edit_start_time').val();
