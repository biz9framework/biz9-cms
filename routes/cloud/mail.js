...
router.post('/send_brevo_mail_message',function(req, res) {
    ...
    set_biz_info=function(){
        ...
        info_r.business_name=biz9_app_config.APP_TITLE;
        info_r.brevo_form_send_subject=BREVO_FORM_SEND_SUBJECT;
        info_r.brevo_form_send_template_id=BREVO_FORM_SEND_TEMPLATE_ID;
        info_r.brevo_sender=biz9_app_config.EMAIL_SENDER;
        info_r.brevo_reply=biz9_app_config.EMAIL_REPLY;
        return info_r;
    }
